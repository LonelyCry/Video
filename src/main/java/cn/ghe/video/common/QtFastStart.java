...
//                System.out.println("QtFastStart------atomType:"+atomType);
    ...
    public static void main(String[] args) throws MalformedFileException, UnsupportedFileException, IOException {
        QtFastStart m = new QtFastStart();
        //
        String sourcePath = "D:\\upload\\2123遇见·泸州老窖_Final版.mp4";
        //String sourcePath = "C:\\Users\\17426\\Downloads\\5b527330214a6.mp4";
        String targetPath = "D:\\upload\\4123遇见·泸州老窖_Final版.mp4";
        File file = new File(sourcePath);
        File file1 = new File(targetPath);
        boolean success = m.fastStart(sourcePath, targetPath);
        FileDeleteTool fileDeleteTool = new FileDeleteTool();
        if(file.exists() && file1.exists()){
            fileDeleteTool.delFile(sourcePath);
